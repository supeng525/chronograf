...
Dygraph.prototype.xTradingHours3 = function () {
  ...
  if(xTradingHours3.nightEnd.getHours() === 0)
  {
    xTradingHours3.type = 1;
    // 0点处理  增加一天
    xTradingHours3.nightEnd = new Date(xTradingHours3.nightEnd.getTime() + 24*60*60*1000);
  } 
  ...
  switch(xTradingHours3.type)
  {
    case 1://非隔夜夜盘
      // 夜盘开始时间不能大于结束时间
      if(xTradingHours3.nightEnd < xTradingHours3.nightStart)// && xTradingHours3.nightEnd.getHours() > 0)
      {
    ...
    case 2:// 隔夜夜盘
      ...
      // 夜盘结束时间不能大于早盘开始时间
      if(xTradingHours3.nightEnd > tradingHours1[0])
      {
        xTradingHours3.nightEnd = tradingHours1[0]
      }
      break;  
  }
  ...
  // console.log('sup1',xTradingHours3)
  return xTradingHours3
       ...
       case 2:
         {  
           // leftMinutes <= 02:00 
            ...
            // 确定最大时间
            // rightMinutes < 09:30  - 02：00//考虑隔夜夜盘
            if(rightMinutes < tradingHours1[2])
            {
              endInterval = (rightMinutes - tradingHours3.endMinutes)*60*1000
            }
      ...
      case 1:
        {
          ...
          {
            stoptime = (tradingHours1[0].getHours()*60 + tradingHours1[0].getMinutes())*60*1000;
          }
          else
          {
