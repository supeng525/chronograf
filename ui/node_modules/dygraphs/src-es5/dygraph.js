...
Dygraph.prototype.__init__ = function (div, file, attrs) {
  ...
  // console.log('sup6',this.attributes_,attrs)
...
// sup test
Dygraph.prototype.xTradingHours1 = function () {
  var tradingHours1 = this.dateWindow_ ? this.dateWindow_ : this.getStringOption("tradingHours1");
  // Optin.tst中默认auto下tradingHours1为0
  if(typeof tradingHours1 === 'undefined' || tradingHours1[0] === '0' || tradingHours1[1] === '0'){
    tradingHours1 = ['','']
  }
  tradingHours1 = [new Date(new Date().toLocaleDateString() + " " + tradingHours1[0]),new Date(new Date().toLocaleDateString() + " " + tradingHours1[1])]
  // 结束时间必须大于开始时间  否则默认结束时间等于开始时间
  if(tradingHours1[1]<tradingHours1[0])
  {
    tradingHours1[1] = tradingHours1[0];
  }
  // 记录开盘时间  按分钟计算[date,date,minute,minute]
  tradingHours1 = [tradingHours1[0],tradingHours1[1],tradingHours1[0].getHours()*60 + tradingHours1[0].getMinutes(),tradingHours1[1].getHours()*60 + tradingHours1[1].getMinutes()]
  return tradingHours1;
};
Dygraph.prototype.xTradingHours2 = function () {
  var tradingHours2 = this.dateWindow_ ? this.dateWindow_ : this.getStringOption("tradingHours2");
  if(typeof tradingHours2 === 'undefined' || tradingHours2[0] === '0' || tradingHours2[1] === '0'){
    tradingHours2 = ['','']
  }
  // console.log('sup1',tradingHours2,new Date().toLocaleDateString() + " " + tradingHours2[0])
  tradingHours2 = [new Date(new Date().toLocaleDateString() + " " + tradingHours2[0]),new Date(new Date().toLocaleDateString() + " " + tradingHours2[1])]
  // tradingHours2[1]必须大于tradingHours2[0]
  if(tradingHours2[1]<tradingHours2[0])
  {
    tradingHours2[1] = tradingHours2[0];
  }
  tradingHours2 = [tradingHours2[0],tradingHours2[1],tradingHours2[0].getHours()*60 + tradingHours2[0].getMinutes(),tradingHours2[1].getHours()*60 + tradingHours2[1].getMinutes()]
  // console.log('sup1',tradingHours2)
  return tradingHours2;
};
// 夜盘 时间
Dygraph.prototype.xTradingHours3 = function () {
  var tradingHours3 = this.dateWindow_ ? this.dateWindow_ : this.getStringOption("tradingHours3");
  var xTradingHours3 ={
    nightStart:new Date(new Date().toLocaleDateString()),
    nightEnd:new Date(new Date().toLocaleDateString()),
    startMinutes:0,
    endMinutes:0,
    type:0,// 0未启用夜盘时间，1为非隔夜夜盘  2为隔夜夜盘
  }
  // console.log('sup13',tradingHours3)
  if(typeof tradingHours3 === 'undefined' || tradingHours3[0] === '0' || tradingHours3[1] === '0'||tradingHours3[1]===''
  || tradingHours3[0]===''){
    // tradingHours3 = ['','']
    return xTradingHours3
  }
  else if(new Date(new Date().toLocaleDateString() + " " + tradingHours3[1]).getHours() === 0)
  {
    xTradingHours3.endMinutes = 24*60;
  }

  xTradingHours3.nightStart = new Date(new Date().toLocaleDateString() + " " + tradingHours3[0]);
  xTradingHours3.nightEnd = new Date(new Date().toLocaleDateString() + " " + tradingHours3[1]);
  // 隔夜夜盘
  if(xTradingHours3.nightEnd.getHours()<12)
  {
    xTradingHours3.type = 2;
  }
  else
  {
    xTradingHours3.type = 1;
  }
  var tradingHours2 = this.xTradingHours2();
  // 夜盘开始时间不能小于下午收盘时间
  if(xTradingHours3.nightStart < tradingHours2[1])
  {
    xTradingHours3.nightStart = tradingHours2[1];
  }
  switch(xTradingHours3.type)
  {
    case 1://非隔夜夜盘
      // 夜盘开始时间不能大于结束时间
      if(xTradingHours3.nightEnd < xTradingHours3.nightStart)
      {
        xTradingHours3.nightEnd = xTradingHours3.nightStart;
      }
      break;
    case 2:// 隔夜夜盘
      var tradingHours1 = this.xTradingHours1();
      // 夜盘结束时间不能大于早盘开始时间
      if(xTradingHours3.nightStart > tradingHours1[0])
      {
        xTradingHours3.nightStart = tradingHours1[0]
      }
      break;  
  }
  xTradingHours3.startMinutes = xTradingHours3.nightStart.getHours()*60 + xTradingHours3.nightStart.getMinutes();
  if(xTradingHours3.endMinutes === 0)
  {
    xTradingHours3.endMinutes = xTradingHours3.nightEnd.getHours()*60 + xTradingHours3.nightEnd.getMinutes();
  }
  // console.log('sup13',xTradingHours3)
  return xTradingHours3
  
  // console.log('sup13',tradingHours3,new Date().toLocaleDateString() + " " + tradingHours3[0])
  //tradingHours3 = [new Date(new Date().toLocaleDateString() + " " + tradingHours3[0]),new Date(new Date().toLocaleDateString() + " " + tradingHours3[1])]
  
  // // console.log('sup14',tradingHours3)
  // // 夜盘考虑
  // var tradingHours1 = this.xTradingHours1();
  // var tradingHours2 = this.xTradingHours2();
  // // 下午收盘时间大于夜盘开始时间时 默认夜盘开始时间为下午收盘时间
  // // console.log('sup21',new Date().toLocaleDateString() + " " + tradingHours3[0],tradingHours3)
  // if (tradingHours3[0].getHours()!=0 && tradingHours2[1] > tradingHours3[0])
  // {
  //   tradingHours3[0] = tradingHours2[1];
  // }
  // // console.log('sup12',tradingHours3)
  // // 非隔夜夜盘时 夜盘收盘时间不大于开始时间
  // if(tradingHours3[1].getHours()>12 && tradingHours3[1]<tradingHours3[0])
  // {
  //   tradingHours3[1] = tradingHours3[0];
  // }
  // // 隔夜夜盘时  夜盘收盘时间不大于早盘开盘时间
  // if(tradingHours3[1].getHours() != 0 && tradingHours3[1].getHours() <= 12 &&  tradingHours3[1] > tradingHours1[0]) 
  // {
  //   tradingHours3[1] = tradingHours1[0];
  // }
  // tradingHours3 = [tradingHours3[0],tradingHours3[1],tradingHours3[0].getHours()*60 + tradingHours3[0].getMinutes(),tradingHours3[1].getHours()*60 + tradingHours3[1].getMinutes()]
  // // console.log('sup11',tradingHours3)
  // return tradingHours3;
};
/**
 * Returns the lower- and upper-bound x-axis values of the data set.
 */
// sup test  修改x时间轴的最大值和最小值
Dygraph.prototype.xAxisExtremes = function () {
  ...
  if (pad) {
   ...
   var tradingHours2 = this.xTradingHours2();
   // 夜盘时间
   var tradingHours3 = this.xTradingHours3();
   var startInterval = 0;
   var endInterval = 0;
   // 按分钟计算的最小时间和最大时间
   var leftMinutes = new Date(left).getHours()*60 + new Date(left).getMinutes();
   var rightMinutes = new Date(right).getHours()*60 + new Date(right).getMinutes();
   // console.log('sup15',tradingHours3,leftMinutes,rightMinutes)
   // tradingHours1和tradingHoues2非空
   if(tradingHours1[2]!=0 && tradingHours1[3]!=0 && tradingHours2[2]!=0 && tradingHours2[3] !=0){
     switch(tradingHours3.type)
     {
       case 0://// 不启用夜盘时间
          {
            // leftMinutes <= 11:30
            if(leftMinutes <= tradingHours1[3])
            {
              startInterval = (leftMinutes-tradingHours1[2])*60*1000
            }// leftMinutes > 15:00
            else if(leftMinutes > tradingHours2[3])
            {
              startInterval = -(tradingHours1[2]+(24*60-tradingHours2[3]))*60*1000
            }// leftMinutes> 11:30 && leftMinutes <=15:00
            else
            {
              startInterval = (leftMinutes - tradingHours2[2])*60*1000
            }
            // 确定最大时间
            // rightMinutes < 09:30  9:30-rightMinutes
            if(rightMinutes <= tradingHours1[2])
            {
              endInterval = (rightMinutes+(24*60 - tradingHours2[3]))*60*1000
            }
            // 09:30 < rightMinutes < 13:00  - 11:30
            else if(rightMinutes <= tradingHours2[2])
            {
              endInterval = (rightMinutes - tradingHours1[3])*60*1000
            }
            // rightMinutes > 13:00  -15:00
            else
            {
              endInterval = (rightMinutes - tradingHours2[3])*60*1000
            }
            break;
          }
       // 非隔夜夜盘
       case 1:
         {
            // leftMinutes <= 11:30 -09:30
            if(leftMinutes <= tradingHours1[3])
            {
              startInterval = (leftMinutes-tradingHours1[2])*60*1000
            }// 11:30 < leftMinutes <= 15:00  -13:00
            else if(leftMinutes <= tradingHours2[3])
            {
              startInterval = (leftMinutes-tradingHours2[2])*60*1000
            }// 15:00 < leftMinutes <= 23:00 小于夜盘  - 21:00
            else if(leftMinutes <= tradingHours3.endMinutes)
            {
              startInterval = (leftMinutes-tradingHours3.startMinutes)*60*1000
            }// leftMinutes> 23:00
            else
            { 
              startInterval = -(tradingHours1[2] + (24*60-leftMinutes))*60*1000
            }
            // 确定最大时间
            // rightMinutes < 09:30  9:30-rightMinutes
            if(rightMinutes <= tradingHours1[2])
            {
              endInterval = (rightMinutes+(24*60 - tradingHours3.endMinutes))*60*1000
            }
            // 09:30 < rightMinutes <= 13:00  - 11:30
            else if(rightMinutes <= tradingHours2[2])
            {
            ...
            // 13:00 < rightMinutes <= 21:00  -15:00
            else if(rightMinutes <= tradingHours3.startMinutes)
            {
              endInterval = (rightMinutes - tradingHours2[3])*60*1000
            } 
            // rightMinutes > 21:00  -23:00
            else
            {
              endInterval = (rightMinutes - tradingHours3.endMinutes)*60*1000
            }
            // console.log('type',tradingHours3)
            break;
         }
        //隔夜夜盘
       case 2:
         {  
           // leftMinutes <= 02:00 
            if(leftMinutes <= tradingHours3.endMinutes)
            {
              startInterval = (tradingHours3.endMinutes - leftMinutes)*60*1000
            }
            // leftMinutes <= 09:30 && >  -9:30 //考虑隔夜夜盘
            else if(leftMinutes <= tradingHours1[2])
            {
              startInterval = (leftMinutes-tradingHours1[2])*60*1000
            }
            // 09:30  < leftMinutes <= 11:30  -09:30
            else if(leftMinutes <= tradingHours1[3])
            {
              startInterval = (leftMinutes-tradingHours1[2])*60*1000
            }// 11:30 < leftMinutes <= 15:00  -13:00
            else if(leftMinutes <= tradingHours2[3])
            {
              startInterval = (leftMinutes-tradingHours2[2])*60*1000
            }// 15:00 < leftMinutes   - 21:00
            else 
            {
              startInterval = (leftMinutes-tradingHours3.startMinutes)*60*1000
            }
            // 确定最大时间
            // rightMinutes < 02:00  - 02：00
            if(rightMinutes <= tradingHours3.endMinutes)
            {
              endInterval = (rightMinutes - tradingHours3.endMinutes)*60*1000
            }
             // leftMinutes <= 09:30 && >  -9:30 //考虑隔夜夜盘
            else if(rightMinutes <= tradingHours1[2])
            {
              endInterval = (tradingHours1[2] - rightMinutes)*60*1000
            }
            // 09:30 < rightMinutes <= 13:00  - 11:30
            else if(rightMinutes <= tradingHours2[2])
            {
    ...
    if(startInterval<0)
    {
      left = left - startInterval;
    }
    if(endInterval > 0 )
    {
      right = right - endInterval;
    }
    //console.log('sup11',tradingHours3.type,startInterval,endInterval,leftMinutes,tradingHours3.endMinutes)
   return [left, right];
  //    // 不启用夜盘时间
  //    if(tradingHours3.type==0)
  //    {//非夜盘时间
  //     // leftMinutes <= 11:30
  //     if(leftMinutes <= tradingHours1[3])
  //     {
  ...
  //    {
  //      // 非隔夜夜盘
  //      if(tradingHours3[2] <= tradingHours3[3] || tradingHours3[3] == 0)
  //      {
  //       // leftMinutes <= 11:30 -09:30
  //       if(leftMinutes <= tradingHours1[3])
  //       {
  ...
  //         startInterval = (leftMinutes-tradingHours2[2])*60*1000
  //       }// 15:00 < leftMinutes <= 23:00 小于夜盘  - 21:00
  //       else if(leftMinutes <= tradingHours3[3])
  //       {
  //         startInterval = (leftMinutes-tradingHours3[2])*60*1000
  //       }// leftMinutes> 23:00
  //       else
  //       { if(tradingHours3[3]!=0)
  //         {
  //           startInterval = -(tradingHours1[2] + (24*60-tradingHours3[3])*60*1000)
  //         } 
  //       }
  //       // 确定最大时间
  //       // rightMinutes < 09:30  9:30-rightMinutes
  ...
  //         if(tradingHours3[3]!=0)
  //         {
  //           endInterval = (rightMinutes+(24*60 - tradingHours3[3]))*60*1000
  //         }
  //       }
  //       // 09:30 < rightMinutes <= 13:00  - 11:30
  //       else if(rightMinutes <= tradingHours2[2])
  ...
  //       }
  //       // 13:00 < rightMinutes <= 21:00  -15:00
  //       else if(rightMinutes <= tradingHours3[2])
  //       {
  //         endInterval = (rightMinutes - tradingHours2[3])*60*1000
  //       } 
  //       // rightMinutes > 21:00  -23:00
  //       else
  //       {
  //         endInterval = (rightMinutes - tradingHours3[3])*60*1000
  //       }
  //      }
  //      // 隔夜夜盘
  //      else
  //      {
  //        // leftMinutes <= 09:30   -02:00 //考虑隔夜夜盘
  //       if(leftMinutes <= tradingHours1[2])
  //       {
  //         startInterval = (leftMinutes-tradingHours3[3])*60*1000
  //       }
  //       // 09:30  < leftMinutes <= 11:30  -09:30
  //       if(leftMinutes <= tradingHours1[3])
  //       {
...
// sup test 获取加入交易时段筛选后x轴scale
Dygraph.prototype.getScale = function () {
  var xRange = this.xAxisRange();
  var tradingHours1 = this.xTradingHours1()
  var tradingHours2 = this.xTradingHours2()
  var tradingHours3 = this.xTradingHours3()
  ...
  // tradingHours不为空的
  var breaktime = 0;
  var breaktimeNight = 0;// 下午盘到夜盘之间的间隔
  var stoptime = 0;
  var scale = xRange[1] - xRange[0] ;
  // 计算最大最小日期实际间隔
  var limitStart = new Date(xRange[0]).getHours()*60 + new Date(xRange[0]).getMinutes();
  var limitEnd = new Date(xRange[1]).getHours()*60 + new Date(xRange[1]).getMinutes();
    // 总天数
  var dayAll = Math.floor((new Date(new Date(xRange[1]).toLocaleDateString()).getTime() 
            - new Date(new Date(xRange[0]).toLocaleDateString()).getTime())/24/60/60/1000);
  // 标记交易时段分类类型  0：为不设置交易时段 1：tradingHours1和2非空 day+1 2:day-1 3:day不变 
  var type =0;//tradingHours1和2均为空
  // 先考虑 tradingHours1和2不为空的情况
  // console.log('sup11',tradingHours3,tradingHours1)
  if(tradingHours1[2]!=0 && tradingHours1[3]!=0 && tradingHours2[2]!=0 && tradingHours2[3] !=0){
    switch(tradingHours3.type)
    {
      // 不启用夜盘
      case 0:
        {
           //中午休市时间
          breaktime = tradingHours2[0].getTime() - tradingHours1[1].getTime()
          // 休市到第二日
          stoptime = 24*60*60*1000 - (tradingHours2[1].getTime() - tradingHours1[0].getTime());
          if(stoptime <= 0)
          {
            stoptime = 0;
          }
          // 确认总共需要减去多少个stoptime和breaktime
          // 09:30 tradingHours1[2] 11:30 tradingHours1[3]
          // 13:00 tradingHours2[2] 15:00 tradingHours2[3]
          // 场景1：min<11:30 &&  max<11:30 day      limitStart <= tradingHours1[3] && limitEnd <= tradingHours1[3]
          // 场景2：min<11:30 &&  13<max<15  day +1  limitEnd >= tradingHours2[2] && limitStart <= tradingHours1[3]
          // 场景3：13<min<15 &&  max<11:30  day -1 limitEnd <= tradingHours1[3] && limitStart >= tradingHours2[2]
          // 场景4：13<min<15 &&  13<max<15  day limitEnd >= tradingHours2[2] && limitStart >= tradingHours2[2]
          if(limitStart <= tradingHours1[3] && limitEnd <= tradingHours1[3]){
            scale = scale - (breaktime*(dayAll) + (stoptime*dayAll));
            type = 1;
          } 
          else if(limitEnd >= tradingHours2[2] && limitStart <= tradingHours1[3]){
            scale = scale - (breaktime*(dayAll+1) + (stoptime*dayAll));
            type = 2;
          }else if(limitEnd <= tradingHours1[3] && limitStart >= tradingHours2[2]) {
            scale = scale - (breaktime*(dayAll-1) + (stoptime*dayAll));
            type = 3;
          }else if(limitEnd >= tradingHours2[2] && limitStart >= tradingHours2[2]) 
          {
            scale = scale - (breaktime + stoptime)*dayAll;
            type = 4;
          }
          break;
        }
      ...
      case 1:
        {
          breaktime = tradingHours2[0].getTime() - tradingHours1[1].getTime();
          breaktimeNight = tradingHours3.nightStart.getTime() - tradingHours2[1].getTime();
          // 休市到第二日
          if(tradingHours3.nightEnd.getHours() === 0)
          {
            stoptime = tradingHours1[0].getTime();
          }
          else
          {
            stoptime = 24*60*60*1000 - tradingHours3.nightEnd.getTime() + tradingHours1[0].getTime();
          }
          
          // 确认总共需要减去多少个stoptime和breaktime breaktimeNight
          // 09:30 tradingHours1[2] 11:30 tradingHours1[3]
          // 13:00 tradingHours2[2] 15:00 tradingHours2[3]
          // 21:00 tradingHours3[2] 23:00 tradingHours3[3]
          // 场景1：min<11:30 &&  max<11:30 day
          // 场景2：min<11:30 &&  13<max<15 break:day+1 breakNight:day
          // 场景3：min<11:30 &&  21<max<23 break:day+1 breakNight:day+1
          // 场景4：13<min<15 &&  09:30<max<11:30 break:day-1 breakNight:day
          // 场景5：13<min<15 &&  13<max<15 break:day breakNight:day
          // 场景6：13<min<15 &&  21<max<23 break:day breakNight:day+1
          // 场景7：21<min<23 &&  09:30<max<11:30 break:day-1 breakNight:day-1
          // 场景8：21<min<23 &&  13<max<15 break:day breakNight:day-1
          // 场景9：21<min<23 &&  21<max<23 break:day breakNight:day
          // 场景1：min<11:30 &&  max<11:30
          if(limitEnd <= tradingHours1[3] && limitStart <= tradingHours1[3])
          {
            scale = scale - (breaktime +  breaktimeNight + stoptime)*dayAll;
            // tradingHours1和2均非空 day
            type = 10;
          } 
          // 场景2：min <= 11:30 && 13 <=max <= 15  
          else if(limitStart <= tradingHours1[3] && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
          {
            scale = scale - breaktime*(dayAll+1) -  (breaktimeNight + stoptime)*dayAll;
            // tradingHours1和2均非空 且day-1
            type = 11;  
          }
          // 场景3：min <= 11:30 && 21 <=max <= 23  
          else if(limitStart <= tradingHours1[3] && limitEnd >= tradingHours3.startMinutes && limitEnd <= tradingHours3.endMinutes)
          {
            scale = scale - breaktime*(dayAll+1) -  breaktimeNight*(dayAll+1) - stoptime*dayAll;
            // tradingHours1和2均非空 且day-1
            type = 12;  
          }
          // 场景4：13<= min <= 15  && 09:30 <=max <= 11:30  
          else if(limitStart >= tradingHours2[2] && limitStart <= tradingHours2[3] && limitEnd >= tradingHours1[2] && limitEnd <= tradingHours1[3])
          {
            scale = scale - breaktime*(dayAll-1) -  breaktimeNight*(dayAll) - stoptime*dayAll;
            // tradingHours1和2均非空 且day-1
            type = 13;  
          }
          // 场景5：13<= min <= 15  && 13 <=max <= 15  
          else if(limitStart >= tradingHours2[2] && limitStart <= tradingHours2[3] && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
          {
            scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll) - stoptime*dayAll;
            type = 14;  
          }
          // 场景6：13<= min <= 15  && 21 <=max <= 23  
          else if(limitStart >= tradingHours2[2] && limitStart <= tradingHours2[3] && limitEnd >= tradingHours3.startMinutes && limitEnd <= tradingHours3.endMinutes)
          {
            scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll+1) - stoptime*dayAll;
            type = 15;  
          }
          // 场景7：21<= min <= 23  && 09 <=max <= 11  
          else if(limitStart >= tradingHours3.startMinutes && limitStart <= tradingHours3.endMinutes && limitEnd >= tradingHours1[2] && limitEnd <= tradingHours1[3])
          {
            scale = scale - breaktime*(dayAll-1) -  breaktimeNight*(dayAll-1) - stoptime*dayAll;
            type = 16;  
          }
          // 场景8：21<= min <= 23  && 13 <=max <= 15  
          else if(limitStart >= tradingHours3.startMinutes && limitStart <= tradingHours3.endMinutes && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
          {
            scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll-1) - stoptime*dayAll;
            type = 17;  
          }
            // 场景9：21<= min <= 23  && 21 <=max <= 23  
          else if(limitStart >= tradingHours3.startMinutes && limitStart <= tradingHours3.endMinutes && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
          {
            scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll) - stoptime*dayAll;
            type = 18;  
      ...
      case 2:
        {
          stoptime = tradingHours1[0].getTime() - tradingHours3.nightEnd.getTime();
          // 确认总共需要减去多少个stoptime和breaktime breaktimeNight
          // 09:30 tradingHours1[2] 11:30 tradingHours1[3]
          // 13:00 tradingHours2[2] 15:00 tradingHours2[3]
          ...
          // 20 场景1：9<min<11:30 &&  <9max<11:30 day
          if(limitStart <= tradingHours1[3] && limitStart >= tradingHours1[2] && limitEnd <= tradingHours1[3] && limitEnd >= tradingHours1[2])
          {
            scale = scale - (breaktime +  breaktimeNight + stoptime)*dayAll;
            // tradingHours1和2均非空 day
            type = 20;
          ...
          //  21 场景2：min<11:30 &&  13<max<15 break:day+1 breakNight:day
          else if(limitStart <= tradingHours1[3] && limitStart >= tradingHours1[2] && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
          {
            scale = scale - breaktime*(dayAll+1) -  (breaktimeNight + stoptime)*dayAll;
            // tradingHours1和2均非空 且day-1
            type = 21;  
          ...
          // 22 场景3：min<11:30 &&  21<max||max<02 break:day+1 breakNight:day+1
          else if(limitStart <= tradingHours1[3] && limitStart >= tradingHours1[2] && (limitEnd >= tradingHours3.startMinutes || limitEnd <= tradingHours3.endMinutes))
          {
            // 隔夜且最大时间为凌晨
            if(limitEnd <= tradingHours3.endMinutes)
            {
              scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll) - stoptime*(dayAll-1);
            }
            else {
              scale = scale - breaktime*(dayAll+1) -  breaktimeNight*(dayAll+1) - stoptime*dayAll;
            }
          ...
          // 25场景6：13<min<15 &&  21<max||max<02 break:day breakNight:day+1
          else if(limitStart >= tradingHours2[2] && limitStart <= tradingHours2[3] && (limitEnd >= tradingHours3.startMinutes || limitEnd <= tradingHours3.endMinutes))
          {
            // 隔夜且最大时间为凌晨
            if(limitEnd <= tradingHours3.endMinutes)
            {
              scale = scale - breaktime*(dayAll-1) -  breaktimeNight*(dayAll) - stoptime*(dayAll-1);
            }
            else {
              scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll+1) - stoptime*dayAll;
            }
          ...
          // 26场景7：21<min||min<02 &&  09:30<max<11:30 break:day-1 breakNight:day-1
          else if((limitEnd >= tradingHours3.startMinutes || limitEnd <= tradingHours3.endMinutes) && limitEnd >= tradingHours1[2] && limitEnd <= tradingHours1[3])
          {
            // 隔夜且最小时间为凌晨
            if(limitStart <= tradingHours3.endMinutes)
            {
              scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll) - stoptime*(dayAll+1);
            }
            else
          ...
          // 27场景8：21<min||min<02 &&  13<max<15 break:day breakNight:day-1
          else if((limitEnd >= tradingHours3.startMinutes || limitEnd <= tradingHours3.endMinutes) && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
          {
            // 隔夜且最小时间为凌晨
            if(limitStart <= tradingHours3.endMinutes)
            {
          ...
          {
            // 隔夜且最小时间为凌晨 最大时间>=23
            if(limitStart <= tradingHours3.endMinutes && limitEnd >= tradingHours3.startMinutes)
            {
              scale = scale - breaktime*(dayAll+1) -  breaktimeNight*(dayAll+1) - stoptime*(dayAll+1);
            }
            else if(limitStart >= tradingHours3.startMinutes && limitEnd <= tradingHours3.endMinutes)
            {
              scale = scale - breaktime*(dayAll-1) -  breaktimeNight*(dayAll-1) - stoptime*(dayAll-1);
            }
            else
    ...
    // 不包括夜盘
    // if(tradingHours3[2]==0 || tradingHours3[3]==0)
    // {
    //     // 中午休市时间
    //     breaktime = tradingHours2[0].getTime() - tradingHours1[1].getTime()
    //     if(breaktime <= 0)
    ...
    // {
    //   breaktime = tradingHours2[0].getTime() - tradingHours1[1].getTime();
    //   breaktimeNight = tradingHours3[0].getTime() - tradingHours2[1].getTime();
    //   // 非隔夜夜盘
    //   if (tradingHours3[2] <= tradingHours3[3] || tradingHours3[3] == 0)
    //   {
    //     if(tradingHours3[3] == 0)
    ...
    //     {
    //       // 休市到第二日
    //       stoptime = 24*60*60*1000 - (tradingHours3[1].getTime() - tradingHours1[0].getTime());
    //     }
    //     // 确认总共需要减去多少个stoptime和breaktime breaktimeNight
    //     // 09:30 tradingHours1[2] 11:30 tradingHours1[3]
    //     // 13:00 tradingHours2[2] 15:00 tradingHours2[3]
    ...
    //     }
    //     // 场景3：min <= 11:30 && 21 <=max <= 23  
    //     else if(limitStart <= tradingHours1[3] && limitEnd >= tradingHours3[2] && limitEnd <= tradingHours3[3])
    //     {
    //       scale = scale - breaktime*(dayAll+1) -  breaktimeNight*(dayAll+1) - stoptime*dayAll;
    //       // tradingHours1和2均非空 且day-1
    //       type = 12;  
    ...
    //     }
    //     // 场景6：13<= min <= 15  && 21 <=max <= 23  
    //     else if(limitStart >= tradingHours2[2] && limitStart <= tradingHours2[3] && limitEnd >= tradingHours3[2] && limitEnd <= tradingHours3[3])
    //     {
    //       scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll+1) - stoptime*dayAll;
    //       type = 15;  
    //     }
    //     // 场景7：21<= min <= 23  && 09 <=max <= 11  
    //     else if(limitStart >= tradingHours3[2] && limitStart <= tradingHours3[3] && limitEnd >= tradingHours1[2] && limitEnd <= tradingHours1[3])
    //     {
    //       scale = scale - breaktime*(dayAll-1) -  breaktimeNight*(dayAll-1) - stoptime*dayAll;
    //       type = 16;  
    //     }
    //     // 场景8：21<= min <= 23  && 13 <=max <= 15  
    //     else if(limitStart >= tradingHours3[2] && limitStart <= tradingHours3[3] && limitEnd >= tradingHours2[2] && limitEnd <= tradingHours2[3])
    //     {
    //       scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll-1) - stoptime*dayAll;
    //       type = 17;  
    //     }
    ...
    //   }
    //   // 隔夜夜盘
    //   else if(tradingHours3[3] < tradingHours1[2])
    //   {
    //     stoptime = tradingHours1[0].getTime() - tradingHours3[1].getTime();
    //     // 确认总共需要减去多少个stoptime和breaktime breaktimeNight
    //     // 09:30 tradingHours1[2] 11:30 tradingHours1[3]
    //     // 13:00 tradingHours2[2] 15:00 tradingHours2[3]
    //     // 21:00 tradingHours3[2] 02:00 tradingHours3[3]
    ...
    //     }
    //     // 22 场景3：min<11:30 &&  21<max||max<02 break:day+1 breakNight:day+1
    //     else if(limitStart <= tradingHours1[3] && limitStart >= tradingHours1[2] && (limitEnd >= tradingHours3[2] || limitEnd <= tradingHours3[3]))
    //     {
    //       // 隔夜且最大时间为凌晨
    //       if(limitEnd <= tradingHours3[3])
    //       {
    //         scale = scale - breaktime*(dayAll) -  breaktimeNight*(dayAll) - stoptime*(dayAll-1);
    //       }
    //       else {
    ...
    //      {
    //        // 隔夜且最小时间为凌晨 最大时间>=23
    //       if(limitStart <= tradingHours3[3] && limitEnd >= tradingHours3[2])
    //       {
    //         scale = scale - breaktime*(dayAll+1) -  breaktimeNight*(dayAll+1) - stoptime*(dayAll+1);
    //       }
    //       else if(limitStart >= tradingHours3[2] && limitEnd <= tradingHours3[3])
    //       {
    //         scale = scale - breaktime*(dayAll-1) -  breaktimeNight*(dayAll-1) - stoptime*(dayAll-1);
    //       }
    //       else
   ...
   var data = {'scale':scale,'type':type,'day':dayAll,'breaktime':breaktime,'stoptime':stoptime,'breaktimeNight':breaktimeNight};
   // console.log('sup3',data)
   return data;
}
// sup test
// 根据设置的交易时段获取scale以及转换对应的X值
Dygraph.prototype.transformX = function (x)
{
  var dataScale = this.getScale();
  var xRange = this.xAxisRange();
  var type = dataScale['type'];
  var breaktime = dataScale['breaktime'];
  var stoptime = dataScale['stoptime'];
  var breaktimeNight = dataScale['breaktimeNight'];
  var day = Math.floor((new Date(new Date(x).toLocaleDateString()).getTime() 
            - new Date(new Date(xRange[0]).toLocaleDateString()).getTime())/24/60/60/1000);
  var breakDay = day;// break需要计算的次数
  var breakNightDay = day; // breakNight需要计算的词数
  var stopDay = day; 
  var tradingHours1 = this.xTradingHours1()
  var tradingHours2 = this.xTradingHours2()
  var tradingHours3 = this.xTradingHours3()
  var timeVal = new Date(x).getHours()*60 + new Date(x).getMinutes();
  var temp = x;
  // console.log('sup',dataScale,type,breaktime)
  switch(type){
    case 0:
       temp = x;
       break;
    ...
    case 2:
      // > 13:00
      if(timeVal >= tradingHours2[2])
      {
        breakDay = day + 1
      }
      temp = x - breaktime*(breakDay) - stoptime*day 
      break;
    case 3:
    case 4:
      // < 11:30
      if(timeVal <= tradingHours1[3])
      {
        breakDay = day - 1
      }
      temp = x - breaktime*(breakDay) - stoptime*day 
    ...
    case 12: //非隔夜 min<11:30 &&  21<max<23 break:day+1 breakNight:day+1
      {// 13 <= timeVal 
        ...
        // > 21点
        if(timeVal >= tradingHours3.startMinutes)
        {
        breakNightDay = day + 1;
        }
        temp = x - breaktime*breakDay -  breaktimeNight*breakNightDay - stoptime*day;
        break;
      }
    case 13: //非隔夜 
    case 14: //非隔夜 
    ...
    case 22: //隔夜 min<11:30 &&  21<max||max<02
       ...
       if(timeVal <= tradingHours3.endMinutes)
       {
         stopDay = day - 1;
       }
       temp = x - breaktime*breakDay -  breaktimeNight*breakNightDay - stoptime*stopDay;
  break;
  case 23: //隔夜 
  case 24: //隔夜 
  ...
  case 28: //隔夜 21<min||min<02 &&  21<max||max<02 break:day breakNight:day
    ...
    if(new Date(xRange[0]).getHours()*60 + new Date(xRange[0]).getMinutes() <= tradingHours3.endMinutes)
    {
      breakDay = breakDay + 1;
 ...
 return temp;
  //  // 大于中午收盘后时间
    ...
    //  { 
    //      temp = x - breaktime*(breakDay) - stoptime*day 
    //  }else if(timeVal<=tradingHours1[3]){//介于tradingHours1 开始和结束之间的时间
    //      temp = x - (breaktime*day + stoptime*day)
    //  }
    //  break;
    ...
    //    if(timeVal >= tradingHours2[2])
    //    { 
    //        temp = x - breaktime*(breakDay+1) - stoptime*day 
    //    }else if(timeVal<=tradingHours1[3]){//介于tradingHours1 开始和结束之间的时间
    //        temp = x - (breaktime * breakDay + stoptime*day)
    //    // console.log('sup1',timeVal,tradingHours1[3])
    //    }
    //    break;
    // case 3://tradingHours1和2非空 //场景3 max>13:00 && min>13:00 
    //    if(timeVal >= tradingHours2[2])
    //    { 
    //        temp = x - (breaktime + stoptime)*day 
    //    }else if(timeVal<=tradingHours1[3]){//介于tradingHours1 开始和结束之间的时间
    //        temp = x - breaktime*(day-1) - stoptime*day
    //    // console.log('sup1',timeVal,tradingHours1[3])
    //    }
    //    break;
...
Dygraph.prototype.toPercentXCoord = function (x) {
  ...
  if (logscale === true) {
    ...
    var dataScale = this.getScale();
    var scale = dataScale['scale'];
    var transformX = this.transformX(x);
    pct = (transformX - xRange[0])/scale;
  }
  return pct;
};
...
Dygraph.prototype.gatherDatasets_ = function (rolledSeries, dateWindow) {
  ...
  for (seriesIdx = num_series; seriesIdx >= 1; seriesIdx--) {
    ...
    // sup test  去掉不在选择的时间范围内的数据点
    var seriesPoints = this.dataHandler_.seriesToPoints(series, seriesName, boundaryIds[seriesIdx - 1][0],this.xTradingHours1(),this.xTradingHours2(),this.xTradingHours3());
    // console.log('sup12',seriesPoints)
    if (this.getBooleanOption("stackedGraph")) {
