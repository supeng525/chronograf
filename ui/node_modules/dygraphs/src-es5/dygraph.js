...
Dygraph.prototype.xTradingHours3 = function () {
  ...
  if(typeof tradingHours3 === 'undefined' || tradingHours3[1] === '0'){
    tradingHours3 = ['','']
  }
  ...
  // console.log('sup21',tradingHours3)
...
Dygraph.prototype.gatherDatasets_ = function (rolledSeries, dateWindow) {
  ...
  for (seriesIdx = num_series; seriesIdx >= 1; seriesIdx--) {
    ...
    var seriesPoints = this.dataHandler_.seriesToPoints(series, seriesName, boundaryIds[seriesIdx - 1][0],this.xTradingHours1(),this.xTradingHours2());
