...
Dygraph.prototype.xAxisExtremes = function () {
  ...
  if (pad) {
   ...
   var startInterval = ((new Date(left).getHours()*60 + new Date(left).getMinutes())-
   (tradingHours1[0].getHours()*60 + tradingHours1[0].getMinutes()))*60*1000
   var endInterval = ((new Date(right).getHours()*60 + new Date(right).getMinutes())-
...
Dygraph.prototype.toPercentXCoord = function (x) {
  ...
  if (logscale === true) {
    ...
    {
      temp = tradingHours2[0].getTime() - tradingHours1[1].getTime()
      if(temp <= 0){
        temp =0
      }
    }
    // console.log('sup7',tradingHours1,tradingHours2[0].getHours(),temp)
    if(new Date(x).getHours() >= tradingHours2[0].getHours()){
      pct = pct = (x - xRange[0] - temp)/(xRange[1]- xRange[0] - temp)
    }
    else{
      pct = pct = (x - xRange[0])/(xRange[1]- xRange[0] - temp)
    }
