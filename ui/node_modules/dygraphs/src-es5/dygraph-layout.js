...
DygraphLayout.prototype._evaluateLimits = function () {
  ...
  // 休市时间
  let breaktime = tradingHours2[0].getTime() - tradingHours1[1].getTime()
  if(breaktime <= 0)
  {
    breaktime = 0
  }
  let day = Math.floor((xlimits[1] - xlimits[0])/24/60/60/1000)
  console.log('sup',day)
  // 休市到第二日
  let stoptime = 24*60*60*1000 - (tradingHours1[1].getTime() - tradingHours1[0].getTime())-
  (tradingHours2[1].getTime() - tradingHours2[0].getTime());
  if(stoptime <= 0)
  {
    stoptime = 0;
  }
  ...
  var xrange = xlimits[1] - xlimits[0] - (breaktime + stoptime)*day;
...
DygraphLayout.calcXNormal_ = function (value, xAxis, logscale) {
  if (logscale) {
    ...
    {
      // console.log('sup',timeVal,xAxis.tradingHours2[2])
