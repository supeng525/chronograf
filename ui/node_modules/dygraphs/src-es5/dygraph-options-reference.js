...
if (typeof process !== 'undefined') {
  if (process.env.NODE_ENV != 'production') {
    ...
    OPTIONS_REFERENCE = // <JSON>
    {
      ...
      "tradingHours1": {
        "default": "['','']*",
        "labels": ["tradingHours1Start","tradingHours1End"],
        "type": "array<string>",
        "description": "trading hours1"
      },
      "tradingHours2": {
        "default": "['','']*",
        "labels": ["tradingHours2Start","tradingHours2End"],
        "type": "array<string>",
        "description": "trading hours2"
      },
      "tradingHours3": {
        "default": "['','']*",
        "labels": ["tradingHours3Start","tradingHours3End"],
        "type": "array<string>",
        "description": "trading hours3"
      },
    }; // </JSON>
    // NOTE: in addition to parsing as JS, this snippet is expected to be valid
    // JSON. This assumption cannot be checked in JS, but it will be checked when
